...
(defun file_sort (num_find num_file)
	(setq num_list (list))
	...
	(setq sorted_list(quick_sort num_list))

	(binary_search num_find sorted_list)
	(with-open-file (write "numsort.txt" :direction :output)
